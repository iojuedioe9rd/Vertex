...
namespace Vertex
{
    ...
    bool ImGuiLink::DrawVec3Control(const std::string& label, glm::vec3& values, float resetValue, float columnWidth)
    {
        bool v = false;
        ImGuiIO& io = ImGui::GetIO();
    ...
    bool ImGuiLink::DrawVec2Control(const std::string& label, glm::vec2& values, float resetValue, float columnWidth)
    {
        bool v = false;
        ImGuiIO& io = ImGui::GetIO();
        auto boldFont = io.Fonts->Fonts[0];
