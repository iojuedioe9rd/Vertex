...
namespace Vertex {
	...
	enum class VERTEX_API ScriptFieldType
	{
		None = 0,
		Float, Double,
	...
	struct VERTEX_API ScriptFieldInstance
	{
		ScriptField Field;
	...
	class VERTEX_API ScriptInstance
	{
	public:
	...
	namespace Utils
	{
		VERTEX_API ScriptFieldType ScriptFieldTypeFromString(std::string_view fieldType);
		

		VERTEX_API const char*  ScriptFieldTypeToString(ScriptFieldType type);
